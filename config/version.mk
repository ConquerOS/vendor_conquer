...
ifeq ($(WITH_GMS),true)
     CONQUER_BUILD_VERSION := conquerOS-$(CONQUER_VERSION)-$(CONQUER_BUILD)-$(CONQUER_HOST_TIME)-$(CONQUER_BUILD_TYPE)-gapps
     CONQUER_BUILD_NUMBER := CQOSP-$(CONQUER_VERSION).$(CONQUER_HOST_TIME)-gapps
else
     CONQUER_BUILD_VERSION := conquerOS-$(CONQUER_VERSION)-$(CONQUER_BUILD)-$(CONQUER_HOST_TIME)-$(CONQUER_BUILD_TYPE)-vanilla
